...
import org.avmframework.HillClimbingMethod;
...
public class GenerateInputData {
  ...
  public static void main(String[] args) {
    ...
    Monitor monitor;
    if (localSearch.getClass().getSimpleName().equals("HillClimbingSearch")) {
      HillClimbingMethod avm = new HillClimbingMethod(
        localSearch, terminationPolicy, initializer);
        monitor = avm.search(vector, objFun);
    } else {
